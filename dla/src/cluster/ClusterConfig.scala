...
trait ClusterSRAMConfig extends ClusterConfig {
  ...
  protected val inActAdrSRAMSize: Int = 486 // 486/3=162, 162+862=1024=1.5KB*1024*8/12-bit
...
trait GNMFCS1Config {
  ...
  protected val N1: Int = 2
  protected val M1: Int = 2
  protected val F1: Int = 1
  protected val C1: Int = 4
  protected val S1: Int = 1
}
